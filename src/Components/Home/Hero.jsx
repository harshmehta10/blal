...
import vector from "../../assets/Svg/homevector.svg";
...
const Hero = () => {
  ...
  return (
    <div>
      <div className="bg-gradient-to-tr from-[#68B92E] to-70% to-[#01635A]">
        <div className="max-w-screen-2xl mx-auto pt-20 lg:pb-32 xl:pb-32 2xl:pb-36 px-10 lg:px-16 flex items-center relative">
          <div className="flex flex-col lg:flex-row w-full justify-between">
            <div
              className="space-y-7 w-2/5 relative z-[999]"
              data-aos="fade-right"
            ...
            >
              ...
              <div className="space-y-7">
                ...
                <div className="flex text-white justify-between w-[310px] lg:w-[480px] lg:max-w-[482px]">
                  <div>
            ...
            <div className="w-3/5 h-[300px] lg:h-auto">
              <img
                src={bg}
                alt="background"
                className="absolute right-5 lg:right-0 bottom-0 lg:bottom-0 max-h-none max-w-none w-[350px] lg:w-[650px] xl:w-[800px] 2xl:w-auto lg:h-[400px] xl:h-auto z-50"
                data-aos="fade-left"
              ...
              <img
                src={vector}
                alt="vector2"
                className="absolute right-2 lg:right-3 -bottom-3 lg:-bottom-5 w-[80%] lg:w-auto"
                data-aos="fade-left"
                data-aos-duration="2000"
              />
            </div>
      ...
      <div className=" px-12 py-10 block lg:hidden">
        {/* <div className="w-full h-full absolute inset-0 bg-white rounded-[12px] z-0 blur-2xl"></div> */}
